...
export function init() {
  ...
  const modifierKeyToDir = {
    // Odds (jkl;): j=up, k=up-left, l=left, ;=down
    j: 'up',         k: 'up-left',    l: 'left',       ';': 'down',
    // Evens (iop[): i=up-right, o=right, p=down-left, [=down-right
    i: 'up-right',   o: 'right',      p: 'down-left',  '[': 'down-right',
  };
